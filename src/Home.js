				...
				<div className='flex flex-col items-center justify-center mx-auto sm:p-3 xl:pb-4 xl:px-4 lg:flex-row lg:max-w-[87rem] w-[85%] lg:p-0'>
					<div className='container relative z-20 flex flex-col justify-center items-center w-full pb-1 mb-16 text-2xl text-gray-700 lg:w-full  sm:items-center lg:items-start lg:mb-0'>
						...
						<p className='relative z-20 block mt-6 my-8 text-base text-gray-500 xl:text-xl sm:text-center lg:text-left'>
							...
							experience! Our user-friendly bot transforms your GitHub data into a
							thrilling adventure, unlocking the full potential of your Slack
							Workspace. With GitQuest, you'll embark on a competitive quest, promoting
							collaboration and rewarding users. Say goodbye to dull work and hello to
					...
					<div className='flex flex-wrap items-center justify-center flex-row p-8 min-w-[18rem] max-md:max-w-[720px]'>
						<div className='relative flex-none items-center justify-center px-5 py-5 my-8 mx-4 w-[20rem] h-[34rem] md:flex-none box-border border-solid border-2 border-gray-300 rounded-3xl'>
							...
							<p className='mt-0 mb-8 md:mb-0 box-border text-slate-400'>
								{' '}
								Unleash the Power of Motivation with GitQuest! Our quest rewards your
								team's bravery with redeemable prizes, inspiring them to reach new
						...
						<div className='relative flex-none items-center justify-center px-5 py-5 my-8 mx-4  w-[20rem] h-[34rem] md:flex-none box-border border-solid border-2 border-gray-300 rounded-3xl'>
							...
							<p className='mt-0 mb-8 md:mb-0 box-border text-gray-400'>
								{' '}
								Transform Work into Adventure with GitQuest! Our quest transforms
								mundane tasks into exciting challenges, spurring your team to work
						...
						<div className='relative flex-none items-center justify-center px-5 py-5 my-8 mx-4  w-[20rem] h-[34rem] md:flex-none box-border border-solid border-2 border-gray-300 rounded-3xl'>
							...
							<p className='my-0 box-border text-slate-400'>
								{' '}
								We inspire collaboration among your brave adventurers by providing a
								shared quest, where teamwork and collaboration are rewarded with
								treasures beyond measure. Join forces and conquer your work like never
								before!{' '}
							</p>
						</div>
						<div className='relative flex-none items-center justify-center px-5 py-5 my-8 mx-4  w-[20rem] h-[34rem] md:flex-none box-border border-solid border-2 border-gray-300 rounded-3xl'>
							...
							<p className='my-0 box-border text-slate-400'>
								{' '}
								GitQuest seamlessly blends into your existing Slack workspace, with nary
								a disturbance to your questing routine! Our integration is a smooth and
								effortless process, allowing ye and your team to embark on your
