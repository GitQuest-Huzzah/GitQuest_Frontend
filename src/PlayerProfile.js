...
export const PlayerProfile = ({ user, gold, xp, rank }) => {
	return (
		<div className='flex justify-center items-center w-[40rem] h-[40rem]'>
			<img src={scroll} className='h-[40rem] w-fit mx-auto py-2.5 text-4xl text-center font-extrabold p-auto flex justify-center items-center' alt='scroll for profile'></img>
