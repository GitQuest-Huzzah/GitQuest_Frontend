...
export const PlayerProfile = ({ user, gold, xp, rank }) => {
	return (
		<div className='flex justify-center items-center w-screen h-screen'>
			<img src={scroll} className='w-[40rem] h-[40rem] mx-auto py-2.5 bottom-1/3 inset-x-0 text-4xl text-center font-extrabold p-auto flex justify-center items-center' alt='scroll for profile'></img>
