			...
			<div className="flex flex-col items-center justify-center mx-auto sm:p-3 xl:pb-4 xl:px-4 lg:max-w-[87rem] lg:p-0">
				<div className="w-3/4 mx-auto mb-10 md:mb-16 flex flex-col items-center">
					...
					<div className="w-full mx-auto mt-4 text-left text-gray-500 md:text-lg md:mt-6">
						...
						questions, concerns, or comments about our GitQuest bot and how it
						can enhance your Slack Workspace, please don't hesitate to reach out
						to us.
						<div>
							<br></br>
						</div>
						<div>
							Fill out our contact form and one of our friendly support
							representatives will get back to you as soon as possible. Thank
							you for choosing GitQuest and we look forward to assisting you!
						</div>
					</div>
				</div>
				<form
					ref={form}
					onSubmit={sendEmail}
					className="grid w-3/4 gap-4 mx-auto sm:grid-cols-2"
				>
					<div>
						<label
							htmlFor="first-name"
					...
					<div className="sm:col-span-2">
						...
						<textarea
							name="message"
							id="message"
							className="w-full h-64 px-3 py-2 text-gray-800 transition duration-100 border rounded-lg outline-none bg-gray-50 focus:ring-4 focus:ring-black dark:focus:ring-white focus:ring-opacity-50 focus:ring-offset-2 focus:outline-none"
						></textarea>
					</div>
				...
				<p className="w-3/4 mx-auto mt-5 text-xs text-gray-400">
					Please allow up to 24-48 hour response. Thank you for choosing
					GitQuest and we look forward to assisting you!
				</p>
			</div>
		</div>
	);
