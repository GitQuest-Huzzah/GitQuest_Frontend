...
const About = () => {
	return (
		<section className='w-full py-12 bg-white dark:bg-gray-800 lg:py-24 min-h-screen'>
			<div className='flex flex-col items-center justify-center mx-auto sm:p-3 xl:pb-4 xl:px-4 lg:max-w-[87rem] lg:p-0'>
				<div className='space-y-12'>
					<div className='w-3/4 mb-20 space-y-5 sm:mx-auto sm:space-y-4 flex flex-col justify-center'>
						<img alt='fanfare' src={fanfare} className='w-auto h-64' />
						<h2 className='relative text-4xl font-extrabold tracking-tight sm:text-5xl dark:text-gray-500 text-center'>
				...
				<div className='flex justify-between w-3/4 gap-8 my-8'>
					<div className='w-1/3 border border-gray-200 rounded-lg shadow-md'>
						<div className='flex flex-col items-center justify-center p-10'>
							<img
								className='w-32 h-32 mb-6 rounded-full'
								src='https://i.stack.imgur.com/frlIf.png'
							/>
							<h2 className='text-lg font-medium dark:text-gray-500'>
								Corbin Campbell
							</h2>
						</div>
					...
					<div className='w-1/3 border border-gray-200 rounded-lg shadow-md'>
						<div className='flex flex-col items-center justify-center p-10'>
							<img
								...
								src='https://i.stack.imgur.com/frlIf.png'
							/>
							<h2 className='text-lg font-medium dark:text-gray-500'>Robert Boles</h2>
						</div>
					...
					<div className='w-1/3 border border-gray-200 rounded-lg shadow-md'>
						<div className='flex flex-col items-center justify-center p-10'>
							<img
								...
								src='https://i.stack.imgur.com/frlIf.png'
							/>
							<h2 className='text-lg font-medium dark:text-gray-500'>Taylor Race</h2>
						</div>
				...
				<div className='flex w-3/4 justify-center gap-8 my-8'>
					<div className='w-1/3 border border-gray-200 rounded-lg shadow-md'>
						<div className='flex flex-col items-center justify-center p-10'>
							<img
								className='w-32 h-32 mb-6 rounded-full'
								src='https://i.stack.imgur.com/frlIf.png'
							/>
							<h2 className='text-lg font-medium dark:text-gray-500'>Ramon Marero</h2>
						</div>
					...
					<div className='w-1/3 border border-gray-200 rounded-lg shadow-md'>
						<div className='flex flex-col items-center justify-center p-10'>
							<img
								...
								src='https://i.stack.imgur.com/frlIf.png'
							/>
							<h2 className='text-lg font-medium dark:text-gray-500'>Kevin Fang</h2>
						</div>
