				...
				<div className="space-y-12">
					<div className="w-full px-20 pb-10 flex flex-col justify-center">
						...
						<p className="text-xl text-gray-500 break-normal">
							Welcome to the GitQuest team, where work and adventure collide!
							Our mission is to turn your GitHub data into an epic journey,
							unlocking the full potential of your Slack Workspace. We are a
							group of skilled innovative developers, who are constantly pushing
							the limits of what's possible. Together, we are a team of
							passionate adventurers, determined to make work more exciting and
							fun! We are dedicated to promoting collaboration, competition, and
					...
					<div className="flex flex-wrap items-center justify-center flex-row p-8 text-gray-900 box-border w-full">
						...
						<div className="relative flex-none items-center justify-center my-8 mx-4 w-80 h-fit md:flex-none border border-gray-200 rounded-lg shadow-md">
							<div className="flex flex-col items-center justify-center p-5">
								<img
									className="w-full h-full mb-6 rounded-full"
									src="https://storage.googleapis.com/slackphotos/TaylorGQ.jpg"
									alt="profile pic"
								/>
								<h2 className="text-lg font-bold dark:text-gray-300">
									Taylor Race
